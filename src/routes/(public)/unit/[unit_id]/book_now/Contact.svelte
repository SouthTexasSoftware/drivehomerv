  ...
  <div class="container-row">
    ...
    <div class="pricing-overview">
      <div class="row fee nightly-rate">
        <p>
          ${unitObject.information.rates_and_fees.pricing.base_rental_fee} x {$customerStore.trip_length}
          Nights
        </p>
        <p>
          ${$customerStore.nightly_rate_sum}
        </p>
      </div>
      ...
      <div class="banner">
        <div class="row fee miles-included">
          <p>Miles included</p>
          <p>{100 * $customerStore.trip_length} mi</p>
        </div>
  ...
  <div class="container-row col">
    ...
    <form
      ...
      use:enhance={async ({ form, data, cancel }) => {
        ...
        let customerId = $customerStore.customerObject?.id || newUUID();
    ...
    >
      <div class="input-wrapper">
        ...
        <input
          ...
          value={$customerStore.customerObject?.first_name || ""}
        />
      </div>
      <div class="input-wrapper">
        ...
        <input
          ...
          value={$customerStore.customerObject?.last_name || ""}
        />
      </div>
      <div class="input-wrapper">
        ...
        <input
          ...
          value={$customerStore.customerObject?.email || ""}
        />
      </div>
      ...
      <div class="input-wrapper">
        ...
        <input
          ...
          value={$customerStore.customerObject?.phone || ""}
        />
      </div>
      <div class="input-wrapper">
        ...
        <div class="contact-methods">
          <div class="method">
            ...
            <input
              type="checkbox"
              name="cm-text"
              checked={$customerStore.customerObject?.preferred_contact_method
                ?.text}
            />
          </div>
          <div class="method">
    ...
    <button type="submit" class="right-arrow" form="contact-form"
      ><ArrowIcon
        active={buttonActive ||
          $customerStore.customerObject?.contact_form_completed}
      /></button
    >
  </div>
</div>
